...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Snippet.proof_agent'
        db.add_column('brubeck_snippet', 'proof_agent',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Snippet.proof_text'
        db.add_column('brubeck_snippet', 'proof_text',
    ...
    def backwards(self, orm):
        ...
        db.create_table('brubeck_proof', (
            ...
            ('proof_text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('brubeck', ['Proof'])

        # Deleting field 'Snippet.proof_agent'
        db.delete_column('brubeck_snippet', 'proof_agent')

        # Deleting field 'Snippet.proof_text'
        db.delete_column('brubeck_snippet', 'proof_text')
