...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Implication.reverses'
        db.add_column('brubeck_implication', 'reverses',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Implication.reverses'
        db.delete_column('brubeck_implication', 'reverses')
