...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Trait', fields ['property', 'space']
        db.create_unique('brubeck_trait', ['property_id', 'space_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Trait', fields ['property', 'space']
        db.delete_unique('brubeck_trait', ['property_id', 'space_id'])
