...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Space.fully_defined'
        db.add_column('brubeck_space', 'fully_defined',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Space.fully_defined'
        db.delete_column('brubeck_space', 'fully_defined')
